{
  ...
  "metadata": {
    "colab": {
      "name": "MNIST.ipynb",
      "provenance": [],
      "authorship_tag": "ABX9TyP/6b/eJQ0lwjgVMeTVMzVa",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/koti/MNIST/blob/master/MNIST.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "97b0c6dc-300b-4754-f8a7-555aebdcb06c"
      },
      "source": [
      ...
      "outputs": [
        {
          ...
          "text": [
            "Epoch 1/5\n",
            "60000/60000 [==============================] - 3s 56us/step - loss: 0.3419 - accuracy: 0.8963\n",
            "Epoch 2/5\n",
            "60000/60000 [==============================] - 3s 52us/step - loss: 0.1741 - accuracy: 0.9464\n",
            "Epoch 3/5\n",
            "60000/60000 [==============================] - 3s 51us/step - loss: 0.1372 - accuracy: 0.9580\n",
            "Epoch 4/5\n",
            "60000/60000 [==============================] - 3s 51us/step - loss: 0.1136 - accuracy: 0.9653\n",
            "Epoch 5/5\n",
            "60000/60000 [==============================] - 3s 49us/step - loss: 0.0999 - accuracy: 0.9691\n"
          ],
          "name": "stdout"
        },
        {
          ...
          "data": {
            "text/plain": [
              "<keras.callbacks.callbacks.History at 0x7fab410f75c0>"
            ]
          },
          "metadata": {
            "tags": []
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "93ab0fd0-1da8-4978-e7bd-1e80a2a335aa"
      },
      "source": [
      ...
      "outputs": [
        ...
        },
        {
          ...
          "data": {
            "text/plain": [
              "[0.10678736134823412, 0.9653000235557556]"
            ]
          },
          "metadata": {
            "tags": []
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "67bacc30-c9c6-4b16-9c21-5a5c11efa68f"
      },
      "source": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "3262c77d-3e85-4dc2-b02a-10708bfe66ee"
      },
      "source": [
        "for i in range(0, 5):\n",
